...
export const TransactionList = () => {
  ...
  // Find subcategories for selected category filter
        ...
        <div className="toolbar-main">
          ...
          <div className="search-box">
            ...
            <input
              ...
              placeholder="Search notes, category, subcategory or payment method..."
          ...
          <div style={{ display: 'flex', gap: '0.35rem', background: 'rgba(255,255,255,0.04)', padding: '0.25rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle)' }}>
