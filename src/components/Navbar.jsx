...
import { LayoutDashboard, ArrowRightLeft, FolderKanban, BarChart3, Plus, Wallet } from 'lucide-react';

export const Navbar = () => {
  const { activeTab, setActiveTab, setIsQuickAddOpen, stats } = useExpense();
